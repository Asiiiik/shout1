...
api = str(input (green+"Enter 1st Lkey : "+red))

message  = str(input(green+"Enter Message : "+cyan))
...
#message  = str(input(cyan+"Enter Message : "+red))
...
headers1["x-api-key"] = api

url1 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
url2 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers3["x-api-key"] = api

url3 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers4["x-api-key"] = api

url4 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers5["x-api-key"] = api

url5 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers6["x-api-key"] = api

url6 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers7["x-api-key"] = api

url7 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers8["x-api-key"] = api

url8 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers9["x-api-key"] = api

url9 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
...
headers10["x-api-key"] = api

url10 = "https://circle.robi.com.bd/mylife/appapi/appcall.php?op=performAction&action=kast&message="+message
